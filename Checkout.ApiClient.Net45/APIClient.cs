...
namespace Checkout
{
    public sealed class APIClient
    {
        ...
        private DrinkInventoryService _drinkInventoryService;
        ...
        public DrinkInventoryService DrinkInventoryService { get
        {
            return _drinkInventoryService ?? (_drinkInventoryService = new DrinkInventoryService());
        } }
